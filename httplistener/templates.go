...
{{end}}`,
	...
	"github.pullrequestreview.irc": "[{{b .Repository.Name}}] {{g .Review.User.Login}} {{.Action}} a review on PR #{{.PullRequest.Number}}: {{trunc .Review.Body 150}} ({{.Review.State}}) {{.Review.HTMLURL}}",
